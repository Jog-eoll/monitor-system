...
/**
 * Isolated SVAC file-content diagnostics for terminal-gateway.
 *
 * <p>This controller does not participate in the normal secure-command publish
 * or control chain. It only validates SVAC file/pack crypto on complete file
 * bytes.</p>
 *
...
@Slf4j
@RestController
@RequestMapping("/api/secure-command/svac/file")
public class SvacFileCryptoDiagnosticController {
