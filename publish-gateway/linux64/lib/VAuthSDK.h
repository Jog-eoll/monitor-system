...
extern "C"
{
	...
	/// @param[out] outLen 返回加密数据长度
	/// @return TRUE-成功 FALSE-失败
	VAuthSDK_API BOOL VAuthSDK_METHOD VAuth_EncryptPackData(int handle, BOOL isSign, const unsigned char *pData, unsigned int dataLen, unsigned char * &pOutData, unsigned int &outLen);
	...
	/// @param[out] outLen 返回加密数据长度
	/// @return TRUE-成功 FALSE-失败
	VAuthSDK_API BOOL VAuthSDK_METHOD VAuth_EncryptFileData(int handle, BOOL isSign, const unsigned char *pData, unsigned int dataLen, unsigned char * &pOutData, unsigned int &outLen);
	...
	/// @param[out] outLen 返回解密数据长度
	/// @return TRUE-成功 FALSE-失败
	VAuthSDK_API BOOL VAuthSDK_METHOD VAuth_DecryptPackData(int handle, BOOL isVerify, const unsigned char *pData, unsigned int dataLen, unsigned char * &pOutData, unsigned int &outLen);
	...
	/// @param[out] outLen 返回解密数据长度
	/// @return TRUE-成功 FALSE-失败
	VAuthSDK_API BOOL VAuthSDK_METHOD VAuth_DecryptFileData(int handle, BOOL isVerify, const unsigned char *pData, unsigned int dataLen, unsigned char * &pOutData, unsigned int &outLen);
