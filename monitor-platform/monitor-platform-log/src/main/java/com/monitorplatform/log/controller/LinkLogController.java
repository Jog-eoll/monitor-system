...
public class LinkLogController {
    ...
    public Result<?> page(@RequestBody(required = false) LinkLogQueryDTO queryDTO) {
        return Result.data(existingLogQueryService.pageLink(queryDTO));
    }
}
