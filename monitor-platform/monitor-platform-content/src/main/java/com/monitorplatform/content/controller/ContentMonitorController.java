...
public class ContentMonitorController {
    ...
    public ApiResponseVO<BoardMonitorPageVO> getBoardMonitorList(@RequestBody(required = false) BoardMonitorListQueryDTO params) {
        ...
        List<String> cardIdList = params != null ? params.getCardIdList() : null;
        try {
            return ApiResponseVO.success(contentMonitorService.getBoardMonitorList(pageNum, pageSize, ipKeyword, cardIdList));
        } catch (Exception e) {
