...
DEFAULT_LOCAL_AUDIT_IMAGE_URL="http://127.0.0.1:21580/api/audit/image/quick"
DEFAULT_LOCAL_AUDIT_TEXT_URL="http://127.0.0.1:21580/api/audit/text"
DEFAULT_LOCAL_AUDIT_VIDEO_URL="http://127.0.0.1:21580/api/audit/video/quick"
...
DEFAULT_LOCAL_AUDIT_AUTH_MODE="none"
DEFAULT_LOCAL_AUDIT_AUTH_URL=""
DEFAULT_LOCAL_AUDIT_AUTH_USERNAME="admin"
DEFAULT_LOCAL_AUDIT_AUTH_PASSWORD=""
...
load_config() {
    if [ -f "$CONFIG_FILE" ]; then
        ...
        LOCAL_AUDIT_AUTH_MODE=$DEFAULT_LOCAL_AUDIT_AUTH_MODE
        LOCAL_AUDIT_AUTH_URL=$DEFAULT_LOCAL_AUDIT_AUTH_URL
        LOCAL_AUDIT_AUTH_USERNAME=$DEFAULT_LOCAL_AUDIT_AUTH_USERNAME
        LOCAL_AUDIT_AUTH_PASSWORD=$DEFAULT_LOCAL_AUDIT_AUTH_PASSWORD
        LOCAL_AUDIT_AUTH_CERT_PATH=$DEFAULT_LOCAL_AUDIT_AUTH_CERT_PATH
        LOCAL_AUDIT_AUTH_TOKEN=$DEFAULT_LOCAL_AUDIT_AUTH_TOKEN
...
LOCAL_AUDIT_IMAGE_URL=http://127.0.0.1:21580/api/audit/image/quick
LOCAL_AUDIT_TEXT_URL=http://127.0.0.1:21580/api/audit/text
LOCAL_AUDIT_VIDEO_URL=http://127.0.0.1:21580/api/audit/video/quick
LOCAL_AUDIT_VIDEO_FRAME_INTERVAL=0.5
LOCAL_AUDIT_VIDEO_MAX_FRAMES=200
LOCAL_AUDIT_VIDEO_SAVE_FRAMES=false
# 本地审核认证: none / bearer / cert-session
LOCAL_AUDIT_AUTH_MODE=none
LOCAL_AUDIT_AUTH_URL=
LOCAL_AUDIT_AUTH_USERNAME=admin
LOCAL_AUDIT_AUTH_PASSWORD=
LOCAL_AUDIT_AUTH_CERT_PATH=
LOCAL_AUDIT_AUTH_TOKEN=
EOF
...
LOCAL_AUDIT_AUTH_MODE=${LOCAL_AUDIT_AUTH_MODE:-${DEFAULT_LOCAL_AUDIT_AUTH_MODE}}
LOCAL_AUDIT_AUTH_URL=${LOCAL_AUDIT_AUTH_URL:-${DEFAULT_LOCAL_AUDIT_AUTH_URL}}
LOCAL_AUDIT_AUTH_USERNAME=${LOCAL_AUDIT_AUTH_USERNAME:-${DEFAULT_LOCAL_AUDIT_AUTH_USERNAME}}
LOCAL_AUDIT_AUTH_PASSWORD=${LOCAL_AUDIT_AUTH_PASSWORD:-${DEFAULT_LOCAL_AUDIT_AUTH_PASSWORD}}
LOCAL_AUDIT_AUTH_CERT_PATH=${LOCAL_AUDIT_AUTH_CERT_PATH:-${DEFAULT_LOCAL_AUDIT_AUTH_CERT_PATH}}
LOCAL_AUDIT_AUTH_TOKEN=${LOCAL_AUDIT_AUTH_TOKEN:-${DEFAULT_LOCAL_AUDIT_AUTH_TOKEN}}
EOF
