...
-- Create database
--
CREATE DATABASE IF NOT EXISTS `monitor_platform` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE `t_content_monitor` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `content_id` varchar(64) NOT NULL COMMENT '内容ID（UUID，来自发布网关）',
