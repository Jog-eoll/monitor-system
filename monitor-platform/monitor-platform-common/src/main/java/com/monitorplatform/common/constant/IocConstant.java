/**  
* @Title: IocConstant.java  
* @Package com.vw.isds.framework.core.constant  
* @Description: TODO(用一句话描述该文件做什么)  
* @author SuWeiMing 
* @date 2021年12月15日  
* @version V1.0  
*/
package com.monitorplatform.common.constant;

import lombok.experimental.UtilityClass;

/**  
* @ClassName: IocConstant  
* @Description: IOC基本常量
* @author SuWeiMing 
* @date 2021年12月15日    
*/
...
public class IocConstant {
	 ...
	 * 应用版本号
	 */
	public static final String IOC_APP_VERSION = "1.0.0-SNAPSHOT";
	 ...
	 * 微服务之间传递的唯一标识
	 */
	public static final String MATE_TRACE_ID = "ioc-trace-id";
	 ...
	 * 服务资源
	 */
	public static final String MATE_SERVICE_RESOURCE = "ioc-service-resource";

	/**
	 * API资源
	 */
	public static final String MATE_API_RESOURCE = "ioc-api-resource";
