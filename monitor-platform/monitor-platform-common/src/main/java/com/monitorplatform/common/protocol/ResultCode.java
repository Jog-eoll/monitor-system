package com.monitorplatform.common.protocol;
...
public enum ResultCode implements IResultCode {
     ...
     * 手机号已被使用
     */
    USER_PHONE_IS_ExIST(11013, "手机号已被使用"),
    /**
     * 邮箱已被使用
     */
    USER_EMAIL_IS_EXIST(11014, "邮箱已被使用"),
    /**
     * 帐号被冻结
     */
    USER_ACCOUNT_FREEZE(11015, "帐号已被冻结，请稍后重试"),
    /**
     * 验证码错误
     */
    CAPTCHA_ERROR(11016, "验证码错误"),
    /**
     * 验证码超时
     */
    CAPTCHA_TIMEOUT(11017, "验证码失效"),
    /**
     * 无权访问
     */
     ...
     * 系统配置不允许删除
     */
    CONFIG_IS_NOT_DELETE(14005, "系统配置不允许删除"),
    /**
     * 文件不存在
     */
     ...
     * 资源ID已存在
     */
    RESOURCE_IS_EXIST(12005, "资源ID已存在"),
    /**
     * 无效资源父节点ID
     */
     ...
     * 级联平台不存在
     */
    PLATFORM_NOT_EXIST(21001, "级联平台不存在");
